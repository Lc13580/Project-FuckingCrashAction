...
FClassRegistrationInfo Z_Registration_Info_UClass_UAnimGraphNode_VrmModifyHumanoidBone;
UClass* UAnimGraphNode_VrmModifyHumanoidBone::GetPrivateStaticClass()
{
	using TClass = UAnimGraphNode_VrmModifyHumanoidBone;
	if (!Z_Registration_Info_UClass_UAnimGraphNode_VrmModifyHumanoidBone.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AnimGraphNode_VrmModifyHumanoidBone"),
			Z_Registration_Info_UClass_UAnimGraphNode_VrmModifyHumanoidBone.InnerSingleton,
			StaticRegisterNativesUAnimGraphNode_VrmModifyHumanoidBone,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAnimGraphNode_VrmModifyHumanoidBone.InnerSingleton;
}
UClass* Z_Construct_UClass_UAnimGraphNode_VrmModifyHumanoidBone_NoRegister()
{
	return UAnimGraphNode_VrmModifyHumanoidBone::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UE_Projects_Project_FuckingCrashAction_Main_Plugins_VRM4U_Source_VRM4UImporter_Private_AnimGraphNode_VrmModifyHumanoidBone_h__Script_VRM4UImporter_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAnimGraphNode_VrmModifyHumanoidBone, UAnimGraphNode_VrmModifyHumanoidBone::StaticClass, TEXT("UAnimGraphNode_VrmModifyHumanoidBone"), &Z_Registration_Info_UClass_UAnimGraphNode_VrmModifyHumanoidBone, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimGraphNode_VrmModifyHumanoidBone), 1194644967U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_Project_FuckingCrashAction_Main_Plugins_VRM4U_Source_VRM4UImporter_Private_AnimGraphNode_VrmModifyHumanoidBone_h__Script_VRM4UImporter_2096760690(TEXT("/Script/VRM4UImporter"),
	Z_CompiledInDeferFile_FID_UE_Projects_Project_FuckingCrashAction_Main_Plugins_VRM4U_Source_VRM4UImporter_Private_AnimGraphNode_VrmModifyHumanoidBone_h__Script_VRM4UImporter_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_Projects_Project_FuckingCrashAction_Main_Plugins_VRM4U_Source_VRM4UImporter_Private_AnimGraphNode_VrmModifyHumanoidBone_h__Script_VRM4UImporter_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
